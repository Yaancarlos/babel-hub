                    ...
                    <thead>
                        <tr className="border-b border-gray-200">
                            ...
                            {assessments.map((ac) => {
                                ...
                                return (
                                    <th key={ac.id} colSpan={ac.assignments.length} className="border-l border-gray-200 bg-primary/10 p-4 text-center">
                        ...
                        {students.map((student, index, studentsObj) => {
                            ...
                            return (
                                <tr key={student.student_id} className="border-t border-gray-100 transition-colors hover:bg-gray-50">
                                    <td className="sticky left-0 border-r z-10 border-gray-200 bg-white p-3">
